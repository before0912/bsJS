...
(function(){
	var DOM = function(){
		...
		bs.cls( 'Style', function( fn, clsfn, bs ){
			...
			b = doc.body.style, pf = detect.stylePrefix, key, conf = {nopx:{}, key:{}, val:{}}, nopx = conf.nopx, keys = conf.key, vals = conf.val, t0, t1;
			clsfn.keys = keys,
			...
			t0 = {keys:keys, key:key, rn:rn, rno:rno, rne:rne, nopx:nopx, trim:trim},
